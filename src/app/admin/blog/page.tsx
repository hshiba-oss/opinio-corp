  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/blog/new" className="inline-flex items-center gap-2 px-4 py-2 bg-primary-800 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm font-medium">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
          ...
          <Link href="/admin/blog/new" className="text-accent-600 font-medium hover:text-accent-700">最初の記事を作成 →</Link>
        </div>
      ) : (
                ...
                <tr key={post.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/admin/blog/${post.id}`} className="p-2 text-gray-400 hover:text-primary-800 transition-colors"><Edit className="w-4 h-4" /></Link>
